 ...
 *
 */
public class GameBoardTwo extends GameBoard implements ActionListener {
	...
	public GameBoardTwo(boolean argIsStart, boolean argIsPlayerOnesTurn, boolean argIsPlayerTwosTurn) {
		...
		super.lblPlayersTurn.setText(playerOnesName + "'s turn");
		setPlayerOnesName(playerOnesName);
		setPlayerTwosName(playerTwosName);
	}
